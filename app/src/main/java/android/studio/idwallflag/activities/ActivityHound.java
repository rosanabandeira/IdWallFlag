...
public class ActivityHound extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.navigation_home:
                        Intent intent1 = new Intent(ActivityHound.this, MainActivity.class);
                        startActivity(intent1);
                        return true;
                    case R.id.navigation_husky:
                        Intent intent2 = new Intent(ActivityHound.this, ActivityHusky.class);
                        startActivity(intent2);
                        return true;
                    case R.id.navigation_hound:
                    case R.id.navigation_pug:
                        Intent intent3 = new Intent(ActivityHound.this, ActivityPug.class);
                        startActivity(intent3);
                        return true;
                    case R.id.navigation_labrador:
                        Intent intent4 = new Intent(ActivityHound.this, ActivityLabrador.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hound);
        ...
        final Call<CategoryResponse> responseCall = getApiService().categoryresponsehound("hound");
        ...
        textViewCategory = findViewById(R.id.textViewCategory_hound);


        recyclerView = findViewById(R.id.recyclerViewHound);
